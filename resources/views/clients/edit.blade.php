            ...
            <div class="bg-white  overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action = "{{route('clients.update', $client)}}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="contact_phone_number" class="block mt-1 w-full" type="tel" name="contact_phone_number" :value="old('contact_phone_number',$client->contact_phone_number)" required autocomplete="username" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="company_zip" class="block mt-1 w-full" type="number" name="company_zip" :value="old('company_zip',$client->company_zip)" required autofocus autocomplete="name" />
